return {
        ...
        opts = {
            ...
            cscope = {
                db_file = {
                    ...
                    -- "~/cscope/project/cscope.in.out",
                    -- "~/cscope/project/cscope.po.out",
                    "~/cscope/test/cscope.out::test/"
                },
                picker = "telescope",
    ...
    },
    {
        ...
        opts = {
            mode = 'cursor',
            on_attach = function() return true end,
